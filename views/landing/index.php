...
<div class="table-layout">
        ...
        <div class="main-container page-header__container page-header__container--index">
            ...
            <div class="header__account--index">
                <a href="#" class="header__account-enter open-modal" data-for="enter-form">
                    <span>Вход</span></a>
                или
                <a href="<?=Url::to('?r=registration/index') ?>" class="header__account-registration">
                    Регистрация
                </a>
            </div>
        </div>
    ...
    <main>
        <div class="landing-container">
            <div class="landing-top">
                ...
                <a href="<?=Url::to('?r=registration/index') ?>"><button class="button">Создать аккаунт</button></a>
            </div>
    ...
    <section class="modal enter-form form-modal" id="enter-form">
        ...
        <?= $form->field($user, 'email')->input('email',['class' => 'enter-form-email input input-middle'])->label('Email') ?>
        <?= $form->field($user, 'password')->passwordInput(['class' => 'enter-form-email input input-middle'])->label('Пароль') ?>
